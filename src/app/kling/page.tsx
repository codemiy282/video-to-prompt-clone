...
export default function KlingGenerator() {
  ...
  const name = t("home.generators.klingTag");
      ...
      <section className="relative overflow-hidden pt-12 pb-16">
        <div className="container mx-auto max-w-4xl px-6 relative z-10">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground">{t("gen.platform.klingTitle")}</h1>
              <p className="text-muted-foreground mt-1">{t("gen.platform.klingDesc")}</p>
            </div>
          </div>
          <div className="mt-8 border border-border rounded-xl p-6 bg-card">
            ...
            <textarea
              ...
              placeholder={t("gen.placeholder.kling")}
