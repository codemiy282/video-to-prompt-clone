...
import { IconCpu, IconArrowLeft, IconLoader2, IconCopy, IconCheck } from "@tabler/icons-react";
      ...
      <section className="relative overflow-hidden pt-12 pb-16">
        <div className="container mx-auto max-w-4xl px-6 relative z-10">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground">Veo 3 Prompt Generator</h1>
              <p className="text-muted-foreground mt-1">Optimize prompts for Google Veo 3 model with audio and music cues.</p>
            </div>
          </div>
          <div className="mt-8 border border-border rounded-xl p-6 bg-card">
            ...
            <textarea
              ...
              placeholder="E.g., cinematic shot of a sunset over an ocean, slow zoom-in, with ambient soft wave sounds and peaceful piano music..."
          ...
          {result && (
            <div className="mt-6 rounded-2xl border border-border bg-card p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-semibold text-lg text-foreground">Generated Veo Prompt</h3>
                <button
                  onClick={handleCopy}
