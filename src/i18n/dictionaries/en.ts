const en = {
  ...
  errors: {
    ...
    VIDEO_UNREADABLE: "Your browser could not read this video. Try an MP4, or a shorter clip.",
  ...
  home: {
    ...
    upload: {
      framesNotice: "Videos over {limit} are handled in your browser: we read {count} still frames from the clip and send only those. The file itself is never uploaded — so length and size stop mattering, but stills carry no audio and no motion.",
      framesProgress: "Reading frames from your video… {done}/{total}",
      title: "Or upload a video file",
      loading: "Analyzing…",
      desc: "MP4, MPEG/MPG, AVI, FLV, WEBM, WMV, 3GPP and MOV. Any length — files over 4 MB are read frame-by-frame in your browser.",
    },
    ...
    faq: {
      ...
      a1: "MP4, MPEG/MPG, AVI, FLV, WEBM, WMV, 3GPP and MOV, at any length. Files up to 4 MB are analysed in full, including motion. Larger files stay on your device: your browser samples 8 still frames and only those are sent, so size stops being a limit — but stills carry no audio or motion.",
      q2: "Is my data safe?",
  ...
  project: {
    ...
    sharedBanner: "You are viewing a shared project. Nothing here is saved to your browser.",
    sharedKeep: "Save as my project",
    sharedDismiss: "Close",
    exportPdf: "Print / PDF",
    splitScene: "Split into two scenes",
    dragScene: "Drag to reorder",
    locked: "Locked",
    ...
    briefAudiencePh: "villa owners, 35-55",
    briefPlatform: "Platform",
    briefPlatformPh: "Facebook Reels",
    briefTone: "Tone",
    briefTonePh: "premium, trustworthy",
    briefCta: "Call to action",
    briefCtaPh: "book a free roof survey",
    briefDuration: "Runtime (seconds)",
    briefSceneEstimate: "About {count} scenes at this length.",
    import: "Import .json",
  ...
  validator: {
    ...
    subtitle:
      "Score your prompt and get concrete, model-aware fixes before you spend render credits.",
    promptLabel: "Your prompt",
    promptPlaceholder: "Paste the video prompt you want to check...",
    scoreFor: "Score for",
    general: "General",
    analyze: "Analyze prompt",
    analyzing: "Analyzing…",
    errorFailed: "Could not analyze the prompt. Please try again.",
    scoreLabel: "Overall score",
    criteriaLabel: "Breakdown",
